...
*https://github.com/asdfwyay/CS283.git*

4. Briefly describe what you want to get out of this class.\
*I hope to further develop the skills I learned from CS 265 and ECEC 201. I also want to learn more about concurrent programming and network programming.*

5. Briefly describe any concerns you might be having with being successful in this class (if any).\
*I will be busy with my senior design project, so I will need to focus on time management. However, in terms of material, I don't have any concerns.*